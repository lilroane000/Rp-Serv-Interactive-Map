...
{             
  ...
  var C_scaleDifference = settings["scaleDifference"] || 1; // Used on wheel zoom
  var C_scaleMax = settings["scaleMax"] || 50;
  ...
  {           
    ...
    /* Set offset limits */
    limitOffsetX = ((elementWidth * targetScale * targetScale) - containerWidth) / 3;
    limitOffsetY = ((elementWidth * targetScale * targetScale) - containerHeight) / 3;
